...
with st.sidebar:
    ...
    st.markdown("H₀: The distance from the city center does not affect the price of an Airbnb listing.")
    st.markdown("*H₁: Airbnb listings closer to the city center tend to have higher prices*")
    st.markdown("---")
    st.markdown("**Models**")
